...
def f_file_load(request):
    ...
    code_dir_create = function_load.direct_create(const_test_load.url, TOKEN)
    ...
    function_load.loading_file(const_test_load.file_name, const_test_load.url_to_file, TOKEN)
